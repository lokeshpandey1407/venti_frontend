        ...
        <>
            {props.alert && (
                <div>
                    <div
                        className={clsx(
                            `fixed z-50 right-2 top-2 items-center w-full max-w-xs p-4 mb-4 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-60 border rounded-lg shadow flex flex-col`,
